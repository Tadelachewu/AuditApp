...
import { Activity, ClipboardCheck, AlertTriangle, FileText } from 'lucide-react';
  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Completed Checklists</CardTitle>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          ...
          <CardContent>
            <p>Recent audit activities will be displayed here.</p>
          </CardContent>
        </Card>
        <Card className="col-span-4 md:col-span-3">
          ...
          <CardContent>
            <p>A list of upcoming audit deadlines will be shown here.</p>
          </CardContent>
        </Card>
      </div>
    </div>
