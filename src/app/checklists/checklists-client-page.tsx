...
export default function ChecklistClientPage({ checklists, userRole }: { checklists: Checklist[], userRole?: Role }) {
  ...
  const canModify = userRole === 'ADMIN' || userRole === 'AUDITOR';
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                {canModify && <TableHead><span className="sr-only">Actions</span></TableHead>}
              </TableRow>
            </TableHeader>
            <TableBody>
